...
今天我在 Hacker News 上看到 Eric Holmes 的文章：[MCP is dead. Long live the CLI](https://ejholmes.github.io/2026/02/28/mcp-is-dead-long-live-the-cli.html)。其中一句话和上面的判断高度一致："The best tools are the ones that work for both humans and machines."
