...
The shift from HITL to HITE is a structural upgrade in the human role:

> **Human-in-the-Loop:** Human approves execution steps.
>
> **Human-in-the-End:** Human defines goals and owns outcomes. Agent executes independently. Intervention occurs only at commit boundaries—when risk exceeds policy, irreversible actions are triggered, or anomalies are detected.

Delegate outcomes, not steps.

This is the design philosophy behind Alan, and the first in a series exploring next-generation agent architecture. Next up: the AI Turing Machine metaphor and why it leads to cleaner runtime design than you'd expect.

---

_This is Part 1 of a series on next-generation agent design. Next: [The AI Turing Machine — Alan's Architecture Philosophy](#) (coming soon). If you're interested in the runtime itself, check out [Alan on GitHub](https://github.com/realmorrisliu/Alan)._
